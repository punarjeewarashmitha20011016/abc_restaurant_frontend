    ...
    return (
        ...
        >
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="left" width="55%">
                                    {props.customerDetails && `${props.customerDetails.firstName} ${props.customerDetails.lastName}`}
                                </td>
                            </tr>
                            <tr>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">:</td>
                                <td align="left">
                                    {props.userDetails && `${props.userDetails.firstName} ${props.userDetails.lastName}`}
                                </td>
                            </tr>
                            <tr>
            ...
            <Box sx={{ textAlign: 'center', paddingBottom: '20px' }}>
                ...
                <Typography>Come again</Typography>
            </Box>
        </Box>
    );
};
